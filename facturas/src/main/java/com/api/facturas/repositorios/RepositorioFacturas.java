...
public interface RepositorioFacturas extends JpaRepository<Factura, Long> {
     ...
     * 
     * @param idUsuario
     * @return {List<Factura>} ultimos7Dias
     */
     ...
     * 
     * @param idUsuario
     * @return {List<Factura>} ultimos30Dias
     */
     ...
     * 
     * @param idUsuario
     * @return {List<Factura>} ultimos180Dias
     */
     ...
     * 
     * @param idUsuario
     * @return {List<Factura>} ultimos365Dias
     */
     ...
     * 
     * @param idCliente
     * @return {List<Factura> porCliente}
     */
    @Query(value = "SELECT * from facturas F WHERE F.cliente_id_cliente = :idCliente", nativeQuery = true)
     ...
     * 
     * @param idUsuario
     * @return {List<String> mejoresClientes}
     */
     ...
     * 
     * @param idUsuario
     * @return {List<Double> mejoresClientes}
     */
