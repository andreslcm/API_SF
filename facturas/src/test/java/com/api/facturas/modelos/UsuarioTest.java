...
class UsuarioTest {
	...
	@Test
	void getContraseÒaTest() {
		
		/** test de getter de Usuario.contrase√±a */
		
		assertTrue(usuarioTest.getContrasena().equals("contrase√±a"));

	}
	
	@Test
	void setContraseÒaTest() {
		
		/** test de setter de Usuario.contrase√±a */
